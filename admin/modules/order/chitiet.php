                ...
                <div class="checkout">
                    <div class="row">
                        <div class="col col-lg-7">
                            <h2 class="checkout__title d-flex align-center space-between">Mã đơn hàng: <?php echo $order_code; ?></h2>
                    ...
                    <a href="?action=order&query=order_add" class="btn btn-outline-dark btn-fw">In Hóa Đơn</a>
                </div>
            </div>
        </div>
    </div>
