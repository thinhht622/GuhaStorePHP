...
$sql_product_list = "SELECT * FROM product JOIN category ON product.product_category = category.category_id ORDER BY product.product_id DESC LIMIT $begin,10";
...
if (isset($_GET['message']) && $_GET['message'] == 'success') {
    ...
    echo '<script>';
    echo '   showErrorToast();';
    echo 'window.history.pushState(null, "", "index.php?action=product&query=product_list");';
    echo '</script>';
}
?>